...
public class Main extends TaskScript {
    ...
    private final API api = new API(this);
     public void onStart() {
         PassableObstacle pb = new PassableObstacle("Cave Entrance", "Enter", null, null, null);
         getWalking().getAStarPathFinder().addObstacle(pb);
         getWalking().getDijPathFinder().addObstacle(pb);
         ...
         bwn1.addConnections(bwn1);
         bwn2.addConnections(bwn2);
         bwn3.addConnections(bwn3);
         bwn4.addConnections(bwn4);
         bwn5.addConnections(bwn5);
         bwn6.addConnections(bwn6);
         bwn7.addConnections(bwn7);
         bwn8.addConnections(bwn8);
         bwn9.addConnections(bwn9);
         bwn10.addConnections(bwn10);
         bwn11.addConnections(bwn11);
         bwn12.addConnections(bwn12);
         bwn13.addConnections(bwn13);
         bwn14.addConnections(bwn14);
         bwn15.addConnections(bwn15);
         bwn16.addConnections(bwn16);
         bwn17.addConnections(bwn17);
         bwn18.addConnections(bwn18);
         bwn19.addConnections(bwn19);
         bwn20.addConnections(bwn20);
         bwn21.addConnections(bwn21);
         bwn22.addConnections(bwn22);
         bwn23.addConnections(bwn23);
         bwn24.addConnections(bwn24);
         bwn25.addConnections(bwn25);
         bwn26.addConnections(bwn26);
         bwn27.addConnections(bwn27);
         bwn28.addConnections(bwn28);
